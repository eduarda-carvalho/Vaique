...
async function importar(){
    ...
    for(let elemento of dados) {
        ...
        function criaDiv(){
            ...
            if (unidade==0){
                divEstoque.innerHTML='esgotado'
            }else{ 
                divEstoque.innerHTML=produtoCadastrado.estoque+unidade
            }
            
            console.log(divEstoque.id)
...
function deletar(botao){
    let idDelete= botao.currentTarget.getAttribute('id')
